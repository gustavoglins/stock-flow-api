...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO update(ProductDTO productDTO) {
        ...
        if (optionalProduct.isPresent()) {
            ...
            throw new RuntimeException("Product not found"); //TODO create a specify exception for this case
        }
    }

    @Override
    public ProductDTO findById(Long id) {
        return new ProductDTO(repository.findById(id).orElseThrow(() -> new RuntimeException("Product not found"))); //TODO create a specify exception for this case
    }
